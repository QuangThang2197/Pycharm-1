...
# p-value = 0.04476 < 0.05
# there is difference in age between 2 group of students

t.test(age ~ group, data = data, alternative = "greater")

# p-value = 0.9776 > 0.05
# there is no difference in age between 2 group of students

t.test(age ~ group, data = data, alternative = "less")

# p-value = 0.02238 < 0.05
# there is difference in age between 2 group of students
